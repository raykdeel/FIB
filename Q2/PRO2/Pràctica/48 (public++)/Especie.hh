...
class Especie {
  ...
  private: 
    ...
    string gen;
    /** @brief Map de subseqüències del gen de l'espècie */
    map<string, int> kmer_def;
...
map<string, int> kmer(string g, int k) ;

//FALTA DOCUMENTAR


map<string, int> consultar_kmer();
