...
public:
    ...
    */
    ...
    void modificar_arbre(const BinTree<Especie>& b);
    ...
    */
    ...
    Cluster fusio_clusters(const Cluster& A, const Cluster& B, const Especie& a);
    ...
    */
    ...
    int consultar_altura(const BinTree<Especie> b);
    ...
    */
    ...
    BinTree<Especie> consultar_arbre() const;
