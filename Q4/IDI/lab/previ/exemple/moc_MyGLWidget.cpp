...
QT_MOC_LITERAL(1, 11, 12), // "sliderKeySet"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "zoom"
QT_MOC_LITERAL(4, 30, 13) // "sliderZoomSet"

    },
    "MyGLWidget\0sliderKeySet\0\0zoom\0"
    "sliderZoomSet"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderKeySet((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sliderZoomSet((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::sliderKeySet)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::sliderKeySet(int _t1)
{
