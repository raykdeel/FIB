...
void MyGLWidget::creaBuffers() {
	m.load("models/Shaun_Hastings.obj");
...
void MyGLWidget::projectTransform() {
    glm::mat4 Proj;    
    if(perspective) Proj=glm::perspective(FOV,ra,znear,zfar); //FOV?
    else Proj=glm::ortho(-radi * rav, radi * rav, -radi, radi, znear, zfar);
...
void MyGLWidget::calculaCapsaEscena ()
{
  ...
  escenaMinima = glm::vec3(-2.5, 0., -2.5); 
}
