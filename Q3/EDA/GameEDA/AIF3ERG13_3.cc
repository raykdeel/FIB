...
struct PLAYER_NAME : public Player {
  ...
  static Player* factory () {
    ...
    bool make_bunker(int id, Pos p) { //haurien de ser molts fors, salta a la primera condició que es compleix, la qual no té perq ser la millor opció
    ...
    void decide_objective() {
        ...
        while(itDec != movements.end()) {
            ...
            else if(c.type == Warrior) run_away(id,p);
            ++itDec;
        }
