...
void Usage() {
	...
	printf("Este programa recibe dos enteros,El programa comenzará mostrando el valor del primer parámetro, a partir del cual a cada segundo lo irá incrementando en 1 y mostrando por pantalla. En caso de recibir un SIGUSR1, mostrará el mensaje: “RESTAN POR ACABAR XXX SEGUNDOS”, siendo XXX el número de incrementos que faltan para mostrar tantos números como indica el segundo parámetro y continuar la ejecución.\n");	
exit(0);
}
int num1;
int num2;
